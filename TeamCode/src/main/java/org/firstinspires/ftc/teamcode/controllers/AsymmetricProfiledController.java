...
public class AsymmetricProfiledController {
    ...
    public AsymmetricProfiledController(
            double Kp, double Ki, double Kd, AsymmetricTrapezoidProfile.Constraints constraints, double period) {
    ...
    public double calculate(
            double measurement, AsymmetricTrapezoidProfile.State goal, AsymmetricTrapezoidProfile.Constraints constraints) {

...
import org.firstinspires.ftc.teamcode.commands.TeleopDriveRevCommand;
...
@TeleOp(name = "Solo IMU", group = "A")
public class TXBetaBotWithRevIMU extends CommandOpMode {
        ...
        private org.firstinspires.ftc.teamcode.opmodes.TXBetaBotSolo.DriverMode currentMode = org.firstinspires.ftc.teamcode.opmodes.TXBetaBotSolo.DriverMode.SAMPLE;
        ...
        public void initialize() {
            ...
            new FunctionalButton(
                    () ->
                            gamepadEx1.getButton(GamepadKeys.Button.START) && currentMode == org.firstinspires.ftc.teamcode.opmodes.TXBetaBotSolo.DriverMode.SAMPLE)
            ...
            new FunctionalButton(
                    () ->
                            gamepadEx1.getButton(GamepadKeys.Button.START)
                                    ...
                                    && currentMode == org.firstinspires.ftc.teamcode.opmodes.TXBetaBotSolo.DriverMode.SAMPLE)
            ...
            // BASKET UP
            new FunctionalButton(
                    () -> gamepadEx1.getButton(GamepadKeys.Button.X) && currentMode == org.firstinspires.ftc.teamcode.opmodes.TXBetaBotSolo.DriverMode.SAMPLE)
                    .whenPressed(
            ...
            new FunctionalButton(
                    () -> gamepadEx1.getButton(GamepadKeys.Button.B) && currentMode == org.firstinspires.ftc.teamcode.opmodes.TXBetaBotSolo.DriverMode.SAMPLE)
                    .whenPressed(
                            liftClaw
                                    .openClawCommand()
                                    .andThen(
            ...
            // FIRST AIM
            new FunctionalButton(
                    () -> gamepadEx1.getButton(GamepadKeys.Button.Y) && currentMode == org.firstinspires.ftc.teamcode.opmodes.TXBetaBotSolo.DriverMode.SAMPLE)
            ...
            new FunctionalButton(
                    () ->
                            gamepadEx1.getButton(GamepadKeys.Button.DPAD_DOWN)
                                    && currentMode == org.firstinspires.ftc.teamcode.opmodes.TXBetaBotSolo.DriverMode.SPECIMEN)
                    .whenPressed(
                            new SequentialCommandGroup(
                                    new InstantCommand(() -> currentMode = org.firstinspires.ftc.teamcode.opmodes.TXBetaBotSolo.DriverMode.SAMPLE),
            ...
            new FunctionalButton(
                    () ->
                            gamepadEx1.getButton(GamepadKeys.Button.DPAD_DOWN)
                                    && currentMode == org.firstinspires.ftc.teamcode.opmodes.TXBetaBotSolo.DriverMode.CLIMB)
                    .whenPressed(new InstantCommand(() -> currentMode = org.firstinspires.ftc.teamcode.opmodes.TXBetaBotSolo.DriverMode.SAMPLE));
                    ...
                    .whenPressed(
                            new SequentialCommandGroup(
                                    new ConditionalCommand(
                                            ...
                                            new InstantCommand(),
                                            () -> slide.getGoal() == SlideSuperStructure.Goal.HANDOFF),
                                    new InstantCommand(() -> currentMode = org.firstinspires.ftc.teamcode.opmodes.TXBetaBotSolo.DriverMode.SPECIMEN),
                                    liftClaw.setLiftClawServo(LiftClaw.LiftClawState.AVOID_COLLISION, 200),
                                    slide
            ...
            new FunctionalButton(
                    () ->
                            gamepadEx1.getButton(GamepadKeys.Button.DPAD_UP) && currentMode == org.firstinspires.ftc.teamcode.opmodes.TXBetaBotSolo.DriverMode.CLIMB)
                    .whenPressed(new InstantCommand(() -> currentMode = org.firstinspires.ftc.teamcode.opmodes.TXBetaBotSolo.DriverMode.SPECIMEN));
            ...
            new FunctionalButton(
                    () -> gamepadEx1.getButton(GamepadKeys.Button.B) && currentMode == org.firstinspires.ftc.teamcode.opmodes.TXBetaBotSolo.DriverMode.SPECIMEN)
                    .whenPressed(
                            new SequentialCommandGroup(
                                    liftClaw.openClawCommand(),
                                    new WaitCommand(100),
            ...
            new FunctionalButton(() -> gamepadEx1.getButton(GamepadKeys.Button.DPAD_LEFT))
                    .whenPressed(new InstantCommand(() -> currentMode = org.firstinspires.ftc.teamcode.opmodes.TXBetaBotSolo.DriverMode.CLIMB));
            ...
            new FunctionalButton(
                    () -> gamepadEx1.getButton(GamepadKeys.Button.B) && currentMode == org.firstinspires.ftc.teamcode.opmodes.TXBetaBotSolo.DriverMode.CLIMB)
                    .toggleWhenPressed(climber.holdOnCommand());
    ...
    public void initializeMode() {
        ...
        if (isLiftArmGrab && isSlideArmFold) {
            currentMode = TXBetaBotSolo.DriverMode.SPECIMEN;
            return;
        }
        ...
        if (isLiftArmStow) {
            if (isSlideArmFold) {
                CommandScheduler.getInstance()
                        .schedule(
                                new SequentialCommandGroup(
                                        new InstantCommand(() -> currentMode = TXBetaBotSolo.DriverMode.SPECIMEN),
                                        liftClaw.setLiftClawServo(LiftClaw.LiftClawState.AVOID_COLLISION, 200),
                ...
                currentMode = TXBetaBotSolo.DriverMode.SAMPLE;
            }
        } else {

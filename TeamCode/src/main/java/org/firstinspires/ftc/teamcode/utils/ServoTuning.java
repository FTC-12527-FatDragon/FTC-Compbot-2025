...
public class ServoTuning extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (opModeIsActive()) {
            ...
            if(originalSmallerPos != -1 && originalBiggerPos != -1 && currentSmallerPos != -1 && currentBiggerPos != -1) {
                mTelemetry.addData("Original Pose", originalPos);
                mTelemetry.addData("Transformed Pose", MathUtils.linear(originalPos, originalSmallerPos, originalBiggerPos, currentSmallerPos, currentBiggerPos));
            }
